            ...
            if (response != null) {
                if (response.error != null) {
                    ...
                    if (loginResult != null) {
                        ...
                        val id = loginResult.id ?: ""
                        val picture = loginResult.picture ?: ""
                        val status = loginResult.status ?: ""
                        val refreshToken = loginResult.token ?: ""

                        Log.d("LoginActivity", "Received user data: $email, $name, $token, $id")
                        viewModel.saveSession(UserModel(id, email, name, token, picture, status, refreshToken))
