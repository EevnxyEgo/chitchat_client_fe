...
class UserPreference private constructor(private val dataStore: DataStore<Preferences>) {
    ...
    suspend fun saveSession(user: UserModel) {
        dataStore.edit { preferences ->
            ...
            Log.d("UserPreference", "Session saved: ${user.id}, ${user.email}, ${user.name}, ${user.accessToken}, ${user.picture}, ${user.status}")
        }
    }
    ...
    companion object {
        ...
        private val REFRESH_KEY = stringPreferencesKey("refreshKey")
